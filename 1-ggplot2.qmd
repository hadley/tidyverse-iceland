...
-   What happens if you replace `geom_point()` with `geom_line()`? Or `geom_col()`? What do we have in mind in this and previous bullet point, given the sole ggplot2 call shown thus far?
